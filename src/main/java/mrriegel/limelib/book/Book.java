...
public class Book {
	...
	public void init() {
		...
		blocks.subChapters.add(new Chapter("Dirt").setText("very useless stuff, not to mention, as i do"));
		blocks.subChapters.add(new Chapter("Sand").setText("fallen fallen fallen fallen fallen fallen fallen fallen"));
		blocks.subChapters.add(new Chapter("furnace").setText("Der Ofen hat ein eigenes Menü, in dem die Schmelzvorgänge vorgenommen werden können. Das Menü besteht aus 3 Feldern: das obere für den Rohstoff"));
		blocks.subChapters.add(new Chapter("kaktus").setText("Der Kaktus kann normalerweise nicht neben anderen Blöcken platziert werden. Ausnahmen sind einige unsolide Blöcke wie Zuckerrohr, Hebel, Knöpfe, Blumen, Setzlinge, Rüstungsständer, Fackeln, Teppiche, Schienen, Schnee, Verstärker und Komparatoren"));
		blocks.subChapters
				.add(new Chapter("DAB")
