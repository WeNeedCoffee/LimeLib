...
public class NBTStackHelper {
	...
	public static NBTTagCompound removeTag(ItemStack stack, String key) {
		return NBTHelper.removeTag(stack.getTag(), key);
	}

	public static <T extends INBTBase> Optional<T> getTagOptional(ItemStack stack, String key) {
		return NBTHelper.getTagOptional(stack.getTag(), key);
	}

	public static <T extends INBTBase> Optional<T> getTagOptional(ItemStack stack, String key, Class<T> clazz) {
	...
	public static <T> NBTTagCompound set(ItemStack stack, String key, T value) {
	...
	public static <T> NBTTagCompound setCollection(ItemStack stack, String key, Collection<T> values) {
	...
	public static <K, V> NBTTagCompound setMap(ItemStack stack, String key, Map<K, V> values) {
