...
public class TestBook extends Book {
	...
	public void init() {
		...
		blocks.addSubChapter(new SubChapter("Dirt", new ItemStack(Blocks.DIRT),new ItemStack(Blocks.GRASS)).setText("VERIE very useless stuff, not to mention, as i do"));
